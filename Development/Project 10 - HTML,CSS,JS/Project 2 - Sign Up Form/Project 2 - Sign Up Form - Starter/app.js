document.querySelector('.banner-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.background = 'rgb(216, 166, 101)';
});
...
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0, 0, 0, .8), rgba(0, 0, 0, .4)), url(images/bg1.jpeg) center/cover no-repeat;';
});
